...
function Contracts(videoID: string) {
	const consumerAddress = "0x185f3fe95FBE8e8418941C7051be66350A002dB5";
    const consumerAbiPath = "./FunctionsConsumer.json"
...
const provider = new ethers.providers.JsonRpcProvider(
  ...
  const args = ["kG-ODpYRREQ"];
  const secrets = { apiKey: process.env.YT_API_KEY }
